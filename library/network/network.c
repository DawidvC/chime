...
void chime_network_initialize(void)
{
    ...
    chime_class_set_instance_method(klass, "on_connection:handler:", tcp_socket_on_connection);
    chime_class_set_instance_method(klass, "on_read:handler:",       tcp_socket_on_read);
